...
export class OrgChangeOperationController {
  ...
  @UseBefore(authMiddleware, hasPermissions(['canEditOrganization']), validationMiddleware(ConnectOperationDto, 'body'))
  ...
  @UseBefore(authMiddleware, hasPermissions(['canEditOrganization']), validationMiddleware(DisconnectOperationDto, 'body'))
